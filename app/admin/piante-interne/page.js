...
export default function IndoorPlantsPage() {
  ...
  async function loadPlants() {
    ...
    const response = await fetch("/api/admin/indoor-plants");
  ...
  function editPlant(plant) {
    ...
    setForm({
      ...
      icon: plant.icon || "🪴",
      category: plant.category || "Pianta da interno",
    ...
    <main className="page">
      <div className="container">
        ...
        <header className="header">
          ...
          <p>
            Gestisci le piante presenti all'interno
            della casa.
          </p>
        </header>
